...
<head>
    ...
    <title>Giftem Globals - Properties </title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="Giftem Global - Properties">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title text-white">Our Properties</h1>
                        <div class="ltn__breadcrumb-list text-white">
                            <ul>
                                ...
                                <li class="ltn__secondary-color">Properties</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-4 text-center">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">// Got any questions?  //</h6>
                            <h1 class="section-title white-color">0802 351 0670</h1>
                        </div>
                        <div class="btn-wrapper">
                            <a href="tel:+234-8023510670" class="theme-btn-1 btn btn-effect-1">MAKE A CALL</a>

...
$pageDetails = $dashboard->getPropertyById($id); // Assumes a method in Dashboard class

if (!$pageDetails) {
    $errorMessage = "Record not found or invalid ID.";
}
$errorMessage = "";
$successMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($dashboard->updateProperty($id, $data)) { // Pass both $sliderId and $data
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Property Page - <?= htmlspecialchars($pageDetails['propertyName']); ?></h5>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        ...
                                        value="<?= htmlspecialchars($pageDetails['propertyName']); ?>" required readonly />
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="location" class="form-label">Location</label>
                                        <input type="text" class="form-control" id="location" name="location"
                                        value="<?= htmlspecialchars($pageDetails['location']); ?>" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" id="description" name="description"
                                         rows="6" maxlength="2000" required><?= htmlspecialchars($pageDetails['description']); ?></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" id="description2" name="description2" rows="6" maxlength="2000" required>

                                        <?= htmlspecialchars($pageDetails['description2']); ?>
                                        </textarea>
                                    </div>

                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-menu-widget clearfix">
                            ...
                            <div class="footer-menu">
                                <ul>
                                    <li><a href="services.php">Estate Development</a></li>
                                    <li><a href="services.php">Property Consultation</a></li>
                                    <li><a href="services.php">Investent Opportunities</a></li>
                                    <li><a href="services.php">Land Titles</a></li>
